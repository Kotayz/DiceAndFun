        ...
        <div>
            <form method="post" action="atualizarBoardgame.php">
                <fieldset>
                    ...
                    <input type="text" id="fabricante" name="fabricante" value="<?php echo $row["fabricante"]; ?>" readonly/>

                    <label>Genero</label>
                    <input type="text" id="genero" name="genero" value="<?php echo $row["genero"]; ?>" readonly/>

                    <label>Duração Partida</label>
                    <input type="text" id="duracao" name="duracao" value="<?php echo $row["duracao"]; ?>" readonly/>

                    <label>Quantidade de Jogadores</label>
                    <input type="number" id="qtdPlayers" name="qtdPlayers" value="<?php echo $row["qtdPlayers"]; ?>" readonly/>

                    <label>Quantidade em Estoque</label>
                    <input type="number" id="estoque" name="estoque" value="<?php echo $row["estoque"]; ?>" readonly/>
                </fieldset>                
            </form>
        </div>
    </body>
