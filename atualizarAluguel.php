...
<?php
    ...
    $sql=mysqli_query($conexao,"UPDATE ALUGUEL SET idCliente = '$idCliente', idBoardgame = '$idBoardgame', idFuncionario = '$idFuncionario', tempoAluguel = '$tempoAluguel' WHERE ID = '$id'");
    if(!$sql) {
