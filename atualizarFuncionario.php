...
<?php
    ...
    $sql=mysqli_query($conexao,"UPDATE FUNCIONARIO SET nome = '$name', idade = '$idade', cpf = '$cpf', rg = '$rg', endereco = '$endereco', numero = '$numero', cep = '$cep', telefone = '$telefone' WHERE ID = '$id'");
    if(!$sql) {
