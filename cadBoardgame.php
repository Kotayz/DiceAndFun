...
<?php
    ...
    $sql=mysqli_query($conexao,"INSERT INTO BOARDGAME(nome, fabricante, genero, duracao, qtdPlayers, estoque) VALUES('$nome', '$fabricante', '$genero', '$duracao', '$qtdPlayers', '$estoque')");
    if(!$sql) {
